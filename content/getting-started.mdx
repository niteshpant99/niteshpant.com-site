...
```
let routes = ["", "essay", "projects", "photos"].map((route) => ({ // Update routes according to your navbar
  url: `${BaseUrl}${route}`,
...
You're all set! Update your essay posts in the **/content** folder, add your project data in **app/project/projectdata.tsx**, and update your images in **app/photos/page.tsx**.
