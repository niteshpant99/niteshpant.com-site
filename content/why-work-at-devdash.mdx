...
> This is written by Nitesh Pant, half the duo behind DevDash Labs.

## दामी काम गरौं

What does it take to build the future of AI? Passion, curiosity, and a relentless drive to create something extraordinary. 

DevDash Labs aims to be the best-in-class, global AI research and development agency, built with Nepali talent. We are a team of Nepali-origin researchers, developers, strategists, designers, and creators who share a passion for AI/ML and innovative technology. Our mission is to make AI accessible, practical, and impactful for businesses of all sizes. We strive by our unofficial motto \- दामी काम गरौं । "गरौं" because we work as a team. We all strive to do amazing work as a team. 
...
At DevDash, we value integrity and trust each other to give our best. No one tracks your hours or lines of code \- we're remote and focused on results. DevDash isn’t for the person seeking a normal 9-5. Our time differences alone don’t allow us to work a normal 9-5. We take initiative and ownership of our work. Some days are shorter, some are longer. Some are easier, some are harder. Some are quick, and yet some seem to stretch space-time. Every team member is transparent in the work they do and strives to do amazing work. When we’re not working on client projects, we are experimenting with new AI technology; we produce approximately one PoC per week. We have a team-wide demo every Friday. Just because we work fast doesn’t mean we lower our standards. 

Whether you’re an intern or a full-time employee, we’ll empower you to do the best work of your career—and have fun while doing it. 
