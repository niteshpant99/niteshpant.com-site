...
const booksData: BookData[] = [
  ...
  },
  {
    ...
    pageCount: 320,
    status: 'reading',
    genres: ['Economics', 'Business', 'Non-Fiction'],
    hasReview: false,
  },
  {
    slug: 'lolita',
  ...
  {
    slug: 'drawing-product-ideas',
    title: 'Drawing Product Ideas',
    author: 'Kent Eisenhuth',
    pageCount: 200,
    status: 'reading',
    genres: ['Design', 'Technology'],
    hasReview: false,
  },
  {
    ...
    status: 'reading',
    isbn: '9780062292988',
    genres: ['Business', 'Technology', 'Startup'],
    hasReview: false,
  },
  {
    slug: 'the-hbr-entrepreneurs-handbook',
    title: "The HBR Entrepreneur's Handbook",
  ...
  {
    slug: 'yes-50-ways-to-be-persuasive',
    title: 'Yes! 50 Scientifically Proven Ways to Be Persuasive',
    author: 'Noah J. Goldstein, Steve J. Martin & Robert Cialdini',
    pageCount: 272,
    status: 'read',
    genres: ['Psychology', 'Business', 'Communication'],
    hasReview: false,
  },
  {
    slug: 'the-small-big',
    title: 'The Small Big: Small Changes That Spark Big Influence',
    author: 'Steve J. Martin, Noah J. Goldstein & Robert Cialdini',
    pageCount: 272,
    status: 'read',
    genres: ['Psychology', 'Business', 'Communication'],
    hasReview: false,
